package com.example.jetsnackme.ui.theme
...
private val LocalJetsnackTypography = staticCompositionLocalOf<JetsnackTypography> {
    error("No JetsnackColorPalette provided")
}
